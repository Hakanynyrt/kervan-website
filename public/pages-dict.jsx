...
const PAGES_DICT = {
  tr: {
    about: {
      ...
      quote: {
        text: 'İşe başladığımda bir fırın, bir tesviye tezgahı ve babamın 30 yıllık deneyimi vardı. Şimdi 40 ülkeye gönderiyoruz. Ama yöntem değişmedi: her keski elle kontrol edilir, her parti sertlik kontrolünden geçer.',
      ...
      items: [
        {
          ...
          prose: 'Yıllık 180 keski + 24 piston. Sertleştirilmiş. Tropik nem koşullarında korozyon koruması için ekstra manganez fosfat. Raporlara göre aftermarket\'e göre %18 daha uzun ömür.',
      ...
      groups: [
        {
          ...
          rows: [
            ['CHS-42', 'Keski 42mm', '42', '520', 'Atlas Copco, Furukawa, Rammer'],
            ['CHS-50', 'Keski 50mm', '50', '580', 'Soosan, Epiroc, Indeco'],
            ['CHS-68', 'Keski 68mm', '68', '720', 'NPK, Krupp, Hanwoo'],
            ['CHS-80', 'Keski 80mm', '80', '880', 'Montabert, Toku'],
            ['CHS-95', 'Keski 95mm', '95', '980', 'Atlas Copco HB5000+'],
            ['CHS-50B', 'Keski 50mm (B)', '50', '580', '15-25 ton kırıcılar'],
          ],
        },
        {
          ...
          rows: [
            ['PST-A120', 'Piston HB3000', '120', '720'],
            ['PST-A140', 'Piston HB4100', '140', '850'],
            ['PST-F110', 'Piston HB30G', '110', '680'],
            ['PST-R130', 'Piston G120', '130', '780'],
            ['PST-S95', 'Piston SB81', '95', '620'],
          ],
        },
        {
          name: 'Burçlar (Bushings)',
          headers: ['REF', 'AD', 'İÇ ÇAP', 'DIŞ ÇAP', 'UZUNLUK'],
          rows: [
            ['BSH-42', 'Burç 42mm', '42', '68', '180'],
            ['BSH-50', 'Burç 50mm', '50', '78', '200'],
            ['BSH-68', 'Burç 68mm', '68', '100', '240'],
            ['BSH-80', 'Burç 80mm', '80', '120', '280'],
          ],
        },
        {
          name: 'Bağlantı elemanları',
          headers: ['REF', 'AD', 'AÇIKLAMA'],
          rows: [
  ...
  en: {
    about: {
      ...
      quote: {
        text: 'When I started there was one furnace, one lathe, and my father\'s 30 years of experience. Now we ship to 40 countries. But the method didn\'t change: every chisel hand-inspected, every batch hardness-checked.',
      ...
      items: [
        {
          ...
          prose: 'Yearly 180 chisels + 24 pistons. Hardened. Extra manganese phosphate for tropical humidity corrosion protection. Reports show 18% longer life vs aftermarket.',
    ...
    catalog: {
      ...
      groups: [
        {
          name: 'Chisels',
          headers: ['REF', 'NAME', 'DIA', 'LENGTH', 'COMPATIBLE BRANDS'],
          rows: [
            ['CHS-42', 'Chisel 42mm', '42', '520', 'Atlas Copco, Furukawa, Rammer'],
            ['CHS-50', 'Chisel 50mm', '50', '580', 'Soosan, Epiroc, Indeco'],
            ['CHS-68', 'Chisel 68mm', '68', '720', 'NPK, Krupp, Hanwoo'],
            ['CHS-80', 'Chisel 80mm', '80', '880', 'Montabert, Toku'],
            ['CHS-95', 'Chisel 95mm', '95', '980', 'Atlas Copco HB5000+'],
            ['CHS-50B', 'Chisel 50mm (B)', '50', '580', '15-25 ton breakers'],
          ],
        },
        {
          name: 'Pistons',
          headers: ['REF', 'NAME', 'DIA', 'LENGTH'],
          rows: [
            ['PST-A120', 'Piston HB3000', '120', '720'],
            ['PST-A140', 'Piston HB4100', '140', '850'],
            ['PST-F110', 'Piston HB30G', '110', '680'],
        ...
        },
        {
          ...
          rows: [
            ['BSH-42', 'Bushing 42mm', '42', '68', '180'],
            ['BSH-50', 'Bushing 50mm', '50', '78', '200'],
            ['BSH-68', 'Bushing 68mm', '68', '100', '240'],
            ['BSH-80', 'Bushing 80mm', '80', '120', '280'],
          ],
        },
        {
          name: 'Fasteners',
