  ...
  tr: {
    about: {
      ...
      timeline: [
        ...
        ['2014', 'EN 10204 3.1 sertifikasyonu', 'Spektrometre, Rockwell sertlik cihazı, metalografi mikroskobu. Her parça sertifikalı çıkmaya başladı.'],
    ...
    gallery: {
      ...
      cells: [
        ...
        ['06 · METALOGRAFI', 'micro'],
        ['07 · PAKETLEME', 'pack'],
        ['08 · FORJ ÜNITESI', 'forge'],
        ['09 · SEVKIYAT', 'ship'],
      ],
    },
    cases: {
    ...
    certs: {
      label: 'BELGELER',
      h1a: 'Her parça ', h1b: 'belgesiyle çıkar.',
      sub: 'Sertifika bizim için pazarlama değil, mühendislik kaydı. Her lot için ayrı EN 10204 3.1 hazırlıyoruz.',
      items: [
        {
          badge: 'EN 10204\n3.1',
          title: 'Malzeme sertifikası — her parça',
          desc: 'Spektrometre kimyasal analizi + Rockwell sertlik ölçümü + boyutsal kontrol. Her keski kendi ID\'siyle arşivde.',
          meta: [['STANDART', 'EN 10204 3.1'], ['GEÇERLI', 'HER PARÇA']],
        },
        {
          badge: 'ISO\n9001',
          title: 'Kalite yönetim sistemi',
          desc: 'Üretim süreçlerinin sertifikalı belgelendirilmesi. Yıllık denetim. Dokümantasyon ve iz sürebilirlik.',
          meta: [['SERTIFIKA NO', 'TR-9001-2019-4412'], ['GEÇERLI', '2027\'YE KADAR']],
        },
        {
          badge: 'CE',
          title: 'Avrupa uygunluk',
          desc: 'Makine Direktifi 2006/42/EC uyumlu. AB\'ye ihraç edilen tüm parçalar CE işaretli.',
          meta: [['DIREKTIF', '2006/42/EC'], ['KAPSAM', 'TÜM AB']],
        },
        {
          badge: 'KIMYA',
          title: 'Spektrometre analizi',
          desc: 'Her lot için optik emisyon spektrometresi raporu. C, Si, Mn, P, S, Cr, Mo, Ni, V değerleri.',
          meta: [['ALET', 'SPECTROMAXx'], ['TOLERANS', '±0.01%']],
        },
        {
          badge: 'RC\n52-56',
          title: 'Rockwell sertlik',
          desc: 'Her keski uç + gövde iki noktadan ölçülür. Hedef: 52-56 HRC (42CrMo), 48-52 HRC (45C).',
          meta: [['ALET', 'WOLPERT DIA TESTOR'], ['BAŞ SAYISI', '10 ATIM']],
        },
        {
          badge: 'DoC',
          title: 'Uygunluk beyanı',
          desc: 'Her sevkiyat için Declaration of Conformity. Gümrük ve müşteri dokümantasyonu için.',
          meta: [['DIL', 'TR/EN/DE/RU'], ['FORMAT', 'PDF/MATBU']],
        },
      ],
    },
    catalog: {
  ...
  en: {
    about: {
      ...
      timeline: [
        ...
        ['2014', 'EN 10204 3.1 certification', 'Spectrometer, Rockwell tester, metallography microscope. Every part started leaving with a certificate.'],
    ...
    certs: {
      ...
      h1a: 'Every part ships ', h1b: 'with its document.',
      sub: 'Certification isn\'t marketing for us, it\'s engineering record. Separate EN 10204 3.1 prepared for each lot.',
      items: [
        {
          badge: 'EN 10204\n3.1',
          title: 'Material certificate — every part',
          desc: 'Spectrometer chemical analysis + Rockwell hardness + dimensional check. Every chisel with its own ID in the archive.',
          meta: [['STANDARD', 'EN 10204 3.1'], ['COVERAGE', 'EVERY PART']],
        },
        {
          badge: 'ISO\n9001',
          title: 'Quality management',
          desc: 'Certified documentation of production processes. Annual audit. Full documentation and traceability.',
          meta: [['CERT NO', 'TR-9001-2019-4412'], ['VALID', 'UNTIL 2027']],
        },
        {
          badge: 'CE',
          title: 'European conformity',
          desc: 'Compliant with Machinery Directive 2006/42/EC. All parts exported to EU are CE-marked.',
          meta: [['DIRECTIVE', '2006/42/EC'], ['SCOPE', 'ENTIRE EU']],
        },
        {
          badge: 'CHEM',
          title: 'Spectrometer analysis',
          desc: 'Optical emission spectrometer report for every lot. C, Si, Mn, P, S, Cr, Mo, Ni, V values.',
          meta: [['DEVICE', 'SPECTROMAXx'], ['TOLERANCE', '±0.01%']],
        },
        {
          badge: 'RC\n52-56',
          title: 'Rockwell hardness',
          desc: 'Every chisel measured at tip + body, two points. Target: 52-56 HRC (42CrMo), 48-52 HRC (45C).',
          meta: [['DEVICE', 'WOLPERT DIA TESTOR'], ['STRIKES', '10 READINGS']],
        },
        {
          badge: 'DoC',
          title: 'Declaration of conformity',
          desc: 'DoC for every shipment. For customs and customer documentation.',
          meta: [['LANGUAGE', 'TR/EN/DE/RU'], ['FORMAT', 'PDF/PRINT']],
        },
      ],
    },
    catalog: {
