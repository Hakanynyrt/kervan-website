  ...
  tr: {
    ...
    process: {
      ...
      steps: [
        ...
        { n:'05', name:'QC', desc:'Sertlik + boyut + yüzey. Her parça.', tag:'ROCKWELL' },
  ...
  en: {
    ...
    process: {
      ...
      steps: [
        ...
        { n:'05', name:'QC', desc:'Hardness + dim + surface. Every piece.', tag:'ROCKWELL' },
  ...
  de: {
    ...
    process: {
      ...
      steps: [
        ...
        { n:'05', name:'QS', desc:'Härte + Maß + Oberfläche. Jedes Stück.', tag:'ROCKWELL' },
  ...
  ru: {
    ...
    process: {
      ...
      steps: [
        ...
        { n:'05', name:'ОТК', desc:'Твёрд. + размеры. Каждая.', tag:'ROCKWELL' },
