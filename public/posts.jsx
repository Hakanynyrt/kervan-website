  ...
  tr: [
    {
      ...
      body: [
        ...
        { type: 'p', text: 'Operatör vardiya başında kumpas + gözle bakış yapar. Deftere yazar. Üç hafta üst üste değişim varsa, keski spec\'i yanlış demektir — farklı bir profil gerekir. Bu noktada bize yazın: referans tablomuzdan uygun olanı söyleyelim.' },
      ],
    },
    {
      slug: 'oem-tuzagi',
      ...
      body: [
        ...
        { type: 'p', text: 'Son 3 yılda 240 kırıcıda karşılaştırmalı veri topladık — OEM keski vs aftermarket. Sonuç: ortalama ömür farkı %4. İstatistiksel olarak gürültü. Fiyat farkı %55-70.' },
        ...
        { type: 'p', text: 'Yani orijinal keskinin fiziksel üretim maliyeti, aftermarket\'in hemen yanında. Spec aynı (genelde aynı Çin/Kore fabrikaları), ısıl işlem prosedürü aynı. Tek fark markalamada.' },
        { type: 'h2', text: 'Ne zaman OEM?' },
        { type: 'p', text: 'İki durumda: (1) garanti dönemindeki yeni makine, (2) leasing\'de "OEM kullanılmalı" klozu varsa. Bunların dışında, aftermarket aynı işi görür.' },
      ],
    },
    {
      ...
      excerpt: 'Sertleştirmeden sonra temperleme doğru yapılmazsa, sertlik kaybı + uzun vadede mikro-çatlak demek.',
      body: [
        ...
        { type: 'p', text: 'Bizim fırınımızda 8 termokupul + PLC kontrol var. Her parça kendi log dosyasıyla çıkar.' },
      ],
    },
  ],
  en: [
    {
      ...
      body: [
        ...
        { type: 'p', text: 'Operator does calipers + eye check at start of shift. Logs to the notebook. Three consecutive weekly swaps means chisel spec is wrong — you need a different profile. At that point write us: we\'ll tell you which one from our reference table.' },
      ],
    },
    {
      slug: 'oem-tuzagi',
      ...
      body: [
        ...
        { type: 'p', text: 'Over the last 3 years we collected comparative data on 240 breakers — OEM chisel vs aftermarket. Result: average life difference 4%. Statistically noise. Price difference 55-70%.' },
        ...
        { type: 'p', text: 'So the physical manufacturing cost of an OEM chisel is right next to aftermarket. Same spec (usually same Chinese/Korean factories), same heat-treat procedure. Only difference is branding.' },
        { type: 'h2', text: 'When OEM?' },
        { type: 'p', text: 'Two situations: (1) new machine under warranty, (2) leasing contract with "OEM only" clause. Beyond these, aftermarket does the same job.' },
      ],
    },
    {
      slug: 'temperleme-profili',
      ...
      excerpt: 'If tempering isn\'t done right after hardening, it means hardness loss + long-term microcracks.',
      body: [
        ...
        { type: 'p', text: 'Our furnace has 8 thermocouples + PLC control. Every part leaves with its own log file.' },
      ],
    },
  ],
